...
int main(int argc, char ** argv) {
    args::ArgumentParser parser("Use a subset of the experiments to build the SeqOthello Group file. \n"
                                "Each group can have approximately 50 experiments. \n"
                                "The input binary files should be in 64bit k-mer format generated by PreProcess.","");
    args::HelpFlag help(parser, "help", "Display the help menu.", {'h', "help"});
    args::ValueFlag<string> argFname(parser, "string", "The list contains the names of the binary files for SeqOthello to build the Group file.", {"flist"});
    args::ValueFlag<string> argFolder(parser, "string", "The directory to the binary files.", {"folder"});
